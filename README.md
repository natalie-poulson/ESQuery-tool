...
## About
This is customized version an existing tool that uses the ESQuery library to query the Abstract Syntax Tree (AST) that's generated by the Esprima parser. The orginal can be found <a href="https://estools.github.io/esquery/" target="_blank">here</a>.

...
## About
This is customized, UI friendly version an existing tool that uses the ESQuery library to query the Abstract Syntax Tree (AST) that's generated by the Esprima parser. The orginal tool on which this is based can be found <a href="https://estools.github.io/esquery/" target="_blank">here</a>.
